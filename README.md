...
`RHLean.lean` is the authoritative source inventory and currently imports **375 Lean modules**. `MODULES.md` maps the source layers, `SEAMS.md` records their exact interfaces, and `CURRENT_PROOF_ROUTE.md` states what is proved, what remains open, and which mechanisms are currently live.
...
- `RHLean.lean` — authoritative 375-module import manifest;
