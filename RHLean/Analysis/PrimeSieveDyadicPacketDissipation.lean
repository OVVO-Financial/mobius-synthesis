...
An earlier layer identifies cumulative deep packet energy as the correct monotone state:
...
the shallow side.  Together with an earlier layer this gives the two exact identities
