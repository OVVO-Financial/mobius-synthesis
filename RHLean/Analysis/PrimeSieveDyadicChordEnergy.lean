...
the earlier development introduced a mean-zero dyadic decomposition of the reciprocal-quotient
prime discrepancy and the boundary-free Abel potential.  the earlier development proved that a
...
the earlier development Abel potential at an index inside the block is exactly the deviation of
...
coordinates which turns the the earlier development energy hypothesis into a concrete curvature
...
/-- The `Nat.log2` block used in the earlier development is literally an integer interval. -/
...
/-- On its own dyadic block, the the earlier development Abel potential is exactly the chord
...
/-- The the earlier development Abel-potential energy is exactly the prime-discrepancy chord energy. -/
...
/-- The the earlier development Abel-energy hypothesis is exactly the dyadic chord-energy
hypothesis. -/
...
/-- The full the earlier development RH reduction can therefore be stated directly in terms of a
